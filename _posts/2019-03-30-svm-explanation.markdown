...
What the above equation tells us is that the optimisation depends **only** on dot products of pairs of samples! This observation will prove key later on.
